...
<div class="no-print flex items-center space-x-3 mb-4">
  <!-- Tombol Cetak -->
  <button onclick="window.print()" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300">
    <i class="fas fa-print mr-2"></i> Cetak Dokumen
  </button>

  <!-- Tombol Kembali -->
  <a href="detail_transaksi.php?id=<?= $id_transaksi ?>" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-gray-600 rounded-lg hover:bg-gray-700 focus:ring-4 focus:ring-gray-300">
